...
export default async function DocumentsLayout({ children, params }: { children: React.ReactNode, params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px' }}>
      <header className="hide-on-print" style={{ borderBottom: '3px solid var(--gov-blue)', paddingBottom: '16px', marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
